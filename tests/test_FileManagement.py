...
class InitializationTest(TestCase):
    ...
    def test_NewMixieCalledWithLatestFiler(self):
        ...
        # self.assertTrue(filerInDB, "The latest Filer was not fetched from the DB")
    ...
    def test_filesInLibraryFetched(self):
        ...
        self.assertEquals(files, {'.%s%s%d.mp3'%(os.sep, testFileName, x) for x in range(3)})
